...
#define FlASH_STORE_START_ADD						ADDR_FLASH_SECTOR_8	
#define FLASH_STORE_END_ADD							ADDR_FLASH_SECTOR_10		//112K

#define FLASH_BOOT_PARA_START_ADDR				ADDR_FLASH_SECTOR_1		
